...
export default function Sidebar() {
  return (
    <aside className="bg-gray-200 dark:bg-gray-800 w-64 p-5 space-y-6 border-r border-gray-200 dark:border-gray-700 fixed h-full z-20">
      <div className="flex justify-between items-center mb-4">
      ...
      <nav className="flex flex-col gap-3 text-sm font-bold">
        {[
          ...
          <Link
            key={path}
            href={path}
            className="p-2.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white"
          >
            {label}
          </Link>
        ))}
        ...
        <button
          ...
          className="flex items-center hover:bg-gray-100 dark:hover:bg-gray-700 gap-2 p-2.5 rounded-md text-gray-600 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white font-bold"
          aria-label="Logout"
        >
          Logout
        </button>
